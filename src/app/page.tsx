...
{[…Object.entries(prices), …Object.entries(prices)].map(([symbol, data], idx) => {
...
{ address: “9rTs…7jWx”, amount: “2.5M”, action: “buy”, time: “8m” }
]);
...
```
  <div className="space-y-2">
    {whales.map((whale, i) => (
      <div key={i} className="bg-black/60 p-3 md:p-4 rounded-xl border border-purple-500/10 hover:border-purple-500/30 transition-all">
        <div className="flex items-center justify-between">
...
const commands = {
“scan”: “> Running contract scan…”,
“whale”: “> Activating whale radar…”,
“status”: “> Network: ONLINE | TPS: 3247”,
“help”: “> Commands: scan, whale, status, clear, help”,
“clear”: “CLEAR”
};
...
```
  ...
  <div className="relative z-10 mt-8 py-4 border-t border-white/10 text-center text-white/40 text-[10px] md:text-xs font-mono">
    <div className="flex items-center justify-center gap-2">
      ...
      SENKU Protocol v5.0 • Built by Bader
    </div>
  </div>
