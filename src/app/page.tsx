...
export default function WagmiEliteTerminal() {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      alert("خطأ في العنوان! تأكد من محفظة سولانا الصحيحة."); 
    } finally { 
      setLoading(false); 
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#000] text-white font-sans selection:bg-cyan-500 overflow-x-hidden">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        ...
        >
          {/* THE LOGO: Sharp & Non-overlapping */}
          <h1 className="text-7xl md:text-[14rem] font-[1000] italic tracking-tight leading-none bg-gradient-to-b from-white via-white to-gray-700 bg-clip-text text-transparent drop-shadow-[0_0_80px_rgba(255,255,255,0.2)]">
            WAGMI
          </h1>
          <p className="text-[10px] md:text-[14px] font-mono tracking-[1.5em] text-cyan-400 uppercase mt-6 font-black italic mb-20 drop-shadow-[0_0_15px_rgba(6,182,212,0.8)]">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full max-w-xl px-4 space-y-6">
          ...
          <button 
            onClick={analyze} 
            disabled={loading} 
            className="w-full py-6 bg-white text-black rounded-full font-black uppercase text-lg tracking-[0.4em] hover:bg-cyan-400 hover:text-white transition-all active:scale-95 shadow-[0_0_50px_rgba(255,255,255,0.15)]"
          >
            {loading ? "INITIALIZING SCAN..." : "AUTHORIZE SCAN"}
          </button>
        </motion.div>
      </section>
        ...
        {data && (
          <section id="result-view" className="relative z-10 py-32 flex flex-col items-center bg-gradient-to-b from-transparent via-cyan-950/20 to-transparent">
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="flex flex-col items-center gap-16 w-full max-w-[600px] px-4">
              ...
              {/* NEON RACING CARD */}
              <div className="relative w-full aspect-[1.58/1] rounded-[2.5rem] md:rounded-[3.5rem] p-[4px] overflow-hidden group shadow-[0_0_120px_rgba(6,182,212,0.4)]">
                ...
                <div ref={cardRef} className="relative w-full h-full bg-[#050505] rounded-[2.3rem] md:rounded-[3.3rem] p-8 md:p-12 overflow-hidden flex flex-col justify-between z-10">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <Radio className="text-cyan-500 animate-pulse w-8 h-8 drop-shadow-[0_0_10px_rgba(6,182,212,1)]" />
                  </div>
                  ...
                  <div className="flex items-center gap-8 text-left">
                    ...
                    <div>
                        <h2 className="text-6xl md:text-8xl font-black tracking-tighter text-white leading-none drop-shadow-2xl">{data.sol}</h2>
                  ...
                  <div className="flex justify-between items-end border-t border-white/5 pt-8">
                    ...
                    <div className="w-16 h-16 bg-cyan-400 rounded-3xl flex items-center justify-center shadow-[0_0_50px_rgba(6,182,212,0.8)]">
              ...
              <button 
                ...
                className="flex items-center gap-4 bg-white/5 border border-white/10 px-12 py-5 rounded-full font-black text-xs uppercase tracking-[0.5em] hover:bg-white hover:text-black transition-all group active:scale-95"
              >
      ...
      <section className="relative z-10 py-40 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            >
              <div className="text-cyan-400 mb-6 group-hover:scale-110 transition-transform duration-500 font-bold">{feat.icon}</div>
      ...
      <footer className="relative z-10 py-20 border-t border-white/5 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            <a href="https://github.com/bedro95" target="_blank" className="flex items-center gap-4 bg-white text-black px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-cyan-400 hover:text-white transition-all group">
              <Github size={20} /> SOURCE CODE <ExternalLink size={16} />
            </a>
            <p className="text-[10px] font-mono tracking-[0.8em] text-gray-600 uppercase">
              Designed by <span className="text-white font-black italic underline decoration-cyan-500 underline-offset-4">Bader Alkorgli</span>
            </p>
          </div>
        </div>
      </footer>
