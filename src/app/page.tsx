  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center selection:bg-[#00FF5F]/30 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl min-h-screen flex flex-col pt-6 pb-20 px-4">
        <div className="w-full bg-black/40 border border-white/5 rounded-[45px] backdrop-blur-3xl overflow-hidden shadow-2xl flex flex-col">
          
          {/* HEADER */}
          <header className="w-full px-10 py-8 flex justify-between items-center border-b border-white/5 bg-gradient-to-r from-white/[0.01] to-transparent">
            <div className="flex items-center gap-6">
              <div className="relative group">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#00FF5F] to-[#00E0FF] rounded-2xl blur opacity-20 transition duration-1000"></div>
                <div className="relative w-14 h-14 bg-black border border-[#00FF5F]/30 rounded-2xl flex items-center justify-center">
              ...
              <div className="flex flex-col">
                <h1 className="text-2xl font-black tracking-[-0.05em] text-white uppercase">
            ...
            <div className="hidden lg:flex items-center gap-4">
               <motion.a whileHover={{ scale: 1.05 }} href="https://github.com/bedro95" target="_blank" className="p-3 bg-white/5 border border-white/10 rounded-xl">
          ...
          <div className="flex flex-col md:flex-row min-h-[75vh]">
              ...
              {TABS.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative p-5 rounded-[22px] transition-all duration-300 ${isActive ? "bg-[#00FF5F]/10 border border-[#00FF5F]/20" : "hover:bg-white/5 opacity-30"}`}
                  >
            ...
            {/* MAIN CONTENT */}
            <main className="flex-1 relative p-6 md:p-12">
          ...
          <footer className="w-full px-10 py-5 flex justify-between items-center bg-black/60 border-t border-white/5 text-[10px] font-mono tracking-widest text-white/20 uppercase">
            ...
            <div className="flex items-center gap-6">
              ...
              >
                <Github className="w-4 h-4 group-hover:text-[#00FF5F]" />
