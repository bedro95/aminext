...
export default function ScientificPassport({ walletAddress = "0x...SOL" }) {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      download(dataUrl, 'senku-scientific-passport.png');
    } catch (err) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-md">
      <div className="flex items-center justify-between px-2">
        <h3 className="text-xl font-black italic tracking-tighter uppercase text-white">Scientific Passport</h3>
        <button 
      ...
      >
        ...
        <div className="relative z-10 flex justify-between items-start">
          <div className="flex flex-col">
            ...
            <span className="text-[8px] font-mono tracking-[0.4em] text-[#00FFCC] uppercase">Research Division</span>
          </div>
        ...
        <div className="relative z-10 flex flex-col gap-1">
          <div className="flex items-center gap-2">
             ...
             <span className="text-[10px] font-mono text-[#00FFCC] uppercase tracking-widest">Active Scientist</span>
          </div>
        ...
        <div className="relative z-10 flex justify-between items-end border-t border-white/10 pt-4">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-xs font-bold text-white uppercase tracking-tighter">Elite Researcher v.3</span>
          </div>
